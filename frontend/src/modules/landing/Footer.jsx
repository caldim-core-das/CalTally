    ...
    <footer className="bg-slate-50 text-slate-400 border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5 mb-5">
              ...
              <span className="text-slate-700 font-semibold text-sm">Cal<span className="text-teal-500">Books</span></span>
            </div>
        ...
        <div className="pt-8 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[11px] text-slate-400">© 2026 CalBooks Technologies Pvt. Ltd. All rights reserved.</p>
